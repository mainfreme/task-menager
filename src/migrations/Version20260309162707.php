...
final class Version20260309162707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ALTER address_geo_lat TYPE NUMERIC(10, 8)');
        $this->addSql('ALTER TABLE users ALTER address_geo_lng TYPE NUMERIC(11, 8)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ALTER address_geo_lat TYPE VARCHAR(50)');
        $this->addSql('ALTER TABLE users ALTER address_geo_lng TYPE VARCHAR(50)');
